...
PUBLIC_HOST = os.environ.get("PUBLIC_HOST", "39.97.43.115")
...
BOT_TARGET_ID = os.environ.get("BOT_TARGET_ID", "1014242991").strip()
ALERT_USER_LABEL = os.environ.get("ALERT_USER_LABEL", "765p").strip()
